...
function Modal(props) {
  ...
  var ref$1 = React.useState("");
  var singleLinkHref = ref$1[0];
  var setSingleLinkHref = ref$1[1];
  var ref$2 = React.useState(false);
  var hasSingleLink = ref$2[0];
  var setHasSingleLink = ref$2[1];
  var ref$3 = React.useState([]);
  var links = ref$3[0];
  var setLinks = ref$3[1];
  var ref$4 = React.useState(false);
  var error = ref$4[0];
  var setError = ref$4[1];
  ...
  return React.createElement("div", {
    ...
    rel: "noopener noreferrer",
    target: "_blank"
  }, props.text.connect_with + " " + (hasSingleLink ? links[0].name : "") + " ›")) : React.createElement("div", {
