...
var WalletConnectProvider = _interopDefault(require('@walletconnect/web3-provider'));
...
var felt_to_str = function felt_to_str(input) {
  ...
  for (var i = 0; i < parsed.length; i += 2) {
    ...
    var num = ethers.BigNumber.from("0x" + curr);
          ...
          var _temp8 = _finallyRethrows(function () {
            return _catch(function () {
              ...
              return Promise.resolve((_params$swo$provider = params.swo.provider) === null || _params$swo$provider === void 0 ? void 0 : _params$swo$provider.callContract({
                ...
                var numberOfApps = ethers.ethers.BigNumber.from(getAppLenResult.result[0]).toNumber();
                var i = 0;
                ...
                var _temp3 = _for(function () {
                  ...
                  return Promise.resolve((_params$swo$provider2 = params.swo.provider) === null || _params$swo$provider2 === void 0 ? void 0 : _params$swo$provider2.callContract({
                    ...
                    return Promise.resolve((_params$swo$provider3 = params.swo.provider) === null || _params$swo$provider3 === void 0 ? void 0 : _params$swo$provider3.callContract({
                      ...
                      var isInstalled = ethers.ethers.BigNumber.from(isInstalledResult.result[0]).toNumber() === 1;
                      ...
                      return Promise.resolve((_params$swo$provider4 = params.swo.provider) === null || _params$swo$provider4 === void 0 ? void 0 : _params$swo$provider4.callContract({
                        ...
                        function _temp2() {
                          return Promise.resolve(fetchAppDetailById(appIdAtIndex, params)).then(function (l1AppData) {
                            tAppData.push({
                              ...
                              Status: 'ACCEPTED',
                              IsInstalled: ethers.ethers.BigNumber.from(isInstalledResult.result[0]).toNumber() === 1,
                              ByoaApp: l1AppData
                            });
                          });
                        }
                        ...
                        var _temp = _for(function () {
                          return j < ethers.ethers.BigNumber.from(appParamCountResult.result[0]).toNumber();
                        }, function () {
                          return j++;
                        }, function () {
...
var default_starknetAddress = "0x0602ddda312f52dac2609a4273c7a731b0e6e4b3aee83c41c6f3b9aa9ac02ae5";
var default_starknetNetwork = 'goerli';
window.byoa = {
  context: {
    target: {
      hud: "byoa-hud"
...
var ByoaSDK = function ByoaSDK(props) {
  ...
  var connectArgentWallet = function connectArgentWallet() {
    try {
      var _temp2 = _catch(function () {
        var starknet = getStarknet.getStarknet();
        setSWO(starknet);
  ...
  return React.createElement(core.Box, {
    ...
    hidden: false,
    icon: React.createElement(core.Box, null, isConnectingArgent && React.createElement(core.CircularProgress, {
      color: "secondary"
    }), !isConnectingArgent && React.createElement(MenuIcon, null)),
    open: openDial,
